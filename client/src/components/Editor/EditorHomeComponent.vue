<template>
    ...
    <main class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 bg-dark text-bg-dark text-light side-bar" style="width: 4.5rem;">
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                <li class="nav-item">
                    <a href="#" class="nav-link active py-3 border-bottom text-bg-dark rounded-0" aria-current="page"
                ...
                <li>
                    <a href="#" class="nav-link py-3 border-bottom rounded-0 text-bg-dark" data-bs-toggle="tooltip"
        ...
        <div class="flex-shrink-0 bg-secondary text-bg-dark side-panel" style="width: 400px;">
...
main {
    ...
    height: calc(-webkit-fill-available - 57px);
    max-height: 100vh;
    overflow-x: auto;
    overflow-y: hidden;
}
