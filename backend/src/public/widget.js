...
* @param {object} scriptElement - Stores the element that will be created later (result variable to avoid declaration
within the method body)
* @param {object} otherScriptElement - The script tag that already located in the body before which we\'ll inject a
newly created script tag (result variable to avoid declaration within the method body)
**/
(function (
  window,
  document,
...
})(window, document, "script", "pf", "./pricingFlow.js");

// configurations that performed by site-owner
pf("init", { someConfiguration: 42 });